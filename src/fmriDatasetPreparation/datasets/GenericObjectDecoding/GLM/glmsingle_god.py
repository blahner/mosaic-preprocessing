...
def main(args):
    ...
    #only valid for test/train perception task
    task = 'perception'
    ...
    for session_count, session in enumerate(session_name):
        ...
        for count, run in enumerate(range(1,numruns+1)):
            ...
            stim_id_prev = 0
            for idx, stim_id in enumerate(tmp.loc[:,'stim_id']):
