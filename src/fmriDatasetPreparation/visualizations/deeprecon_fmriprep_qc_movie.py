...
runs). --max_sessions evenly subsamples the ~24 sessions to a manageable
movie length by default.

Usage
-----
  python deeprecon_fmriprep_qc_movie.py [--tasks perception] [--max_sessions 8]
                                         [--subs sub-01 sub-02 ...]
